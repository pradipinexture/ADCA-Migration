		...
		<clay:row>
			<c:if test="<%= !displaySchedulerOnly %>">
				...
				>
					...
					<div id="<portlet:namespace />calendarListContainer">
						...
						<div class="calendar-portlet-list" style="display: none;">
			...
			>
				...
				<liferay-util:include page="/scheduler.jsp" servletContext="<%= application %>">
					...
					<liferay-util:param name="viewCalendarBookingURL" value="/group/portal/events/detail?id={calendarBookingId}" />
