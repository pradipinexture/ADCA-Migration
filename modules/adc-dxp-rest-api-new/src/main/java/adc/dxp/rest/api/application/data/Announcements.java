 ...
 *
 */
public class Announcements extends BaseContent {
	
	private String body;
	
	public Announcements(JournalArticle article, String languageId) {
		
		super(article, Optional.of(languageId == null ? Constants.DEFAULT_VALUE_LANGUAGE : languageId), ContentType.ANNOUNCEMENT);
		
		if (getAttributes() != null && getAttributes().containsKey("Body")) {
