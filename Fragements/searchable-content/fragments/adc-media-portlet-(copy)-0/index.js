    ...
    function processResponse(articles) {
        ...
        for (let article of articles.items) {
            ...
            mediaJson.push(`<div class="col-md-4 v-space " style="height:300px">
                <a href="/group/portal/promotions/detail?id=${article.articleId}" class="bg-white card h-100 overflow-hidden">
                    <div class="col mx-auto hover-box position-relative d-flex flex-column justify-content-end overflow-hidden p-3 h-100">
                        ...
                        <small class="text-white z-index-10"><i class="icon-calendar mr-2"></i>${stringfyDate(article.displayDate)} <i class="icon-arrow-right mx-2"></i>${stringfyDate(article.endDate)}</small>
